...
final class MovieQuizViewController: UIViewController {
    ...
    private func showNextQuestionOrResults() {
        if currentQuestionIndex == questions.count - 1 { // в состояние "Результат квиза"
            let resultText = "Ваш результат: \(correctAnswers)/10"
            let viewModelAlert = QuizResultsViewModel(title: "Этот раунд окончен!", text: resultText, buttonText: "Сыграть еще раз")
